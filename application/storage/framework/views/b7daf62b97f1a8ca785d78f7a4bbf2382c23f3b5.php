<div class="row">
	<div id="agendamento" class="form-sidenav card col s8 no-padding" data-dismissible="true" data-edge="right" data-backdrop="false" style="height: calc(100vh - 64px); overflow: hidden;">
		...
		<form action="<?php echo e(route('clinica.agendamentos.post')); ?>" method="post" enctype="multipart/form-data" autocomplete="off" novalidate>
					...
					<div class="row mt-2">
						<div class="col s12">
							<div class="input-field">
								...
								<input type="text" name="localidade" value="<?php echo e(isset($row) && $row->clinica ? $row->clinica : null); ?>">
							</div>
						</div>
					</div>
					<div class="row">

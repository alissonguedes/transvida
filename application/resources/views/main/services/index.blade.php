			...
			<div class="row">
				<div class="col s12 m3 l3">
					<ul class="tabs vertical">
						<li class="tab"><a href="{{ route('main.services.index') }}" class="red-text text-darken-2 bold">Atendimento</a></li>
						<li class="tab"><a href="{{ route('main.services.medicos') }}" class="red-text text-darken-2 bold">Serviços Médicos</a></li>
						<li class="tab"><a href="{{ route('main.services.area_protegida') }}" class="red-text text-darken-2 bold">Área Protegida</a></li>
						<li class="tab"><a href="{{ route('main.services.remocao') }}" class="red-text text-darken-2 bold">Remoção e Transporte</a></li>
						<li class="tab"><a href="{{ route('main.services.comercial') }}" class="red-text text-darken-2 bold">Comercial</a></li>
					</ul>
				</div>

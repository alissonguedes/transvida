			...
			t = function(t) {
				...
				return _inherits(n, Component), _createClass(n, [{
					...
					value: function() {
						...
						i.classList.add(this.options.position);
					}
				}, {
		...
		var e = {
			...
			t = function(t) {
				...
				return _inherits(s, Component), _createClass(s, [{
					...
					value: function(t) {
						var e = t.text().trim();
						var n = t[0].dataset.name;
						var i = t[0].dataset.id;
						this.el.value = e,
							this.$el.trigger("change"),
							this._resetAutocomplete(),
							this.close(),
							"function" == typeof this.options.onAutocomplete && this.options.onAutocomplete.call(this, n, i, e);
					}
				}, {
					key: "_renderDropdown",
					value: function(t, i) {
						...
						for (var a = 0; a < e.length; a++) {
							var r = e[a],
								l = h('<li data-name="' + r.name + '" data-id="' + r.value + '"></li>');
		...
		var e = {
			...
			t = function(t) {
				...
				return _inherits(l, Component), _createClass(l, [{
					...
					value: function() {
						var e = this;
						this.options.autocompleteOptions.onAutocomplete = function(t, i) {
							e.addChip({
								tag: t

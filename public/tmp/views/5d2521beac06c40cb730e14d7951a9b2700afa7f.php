	...
	<div class="topbar-fixed topbar-color flex flex-auto z-depth-1">
		<div class="flex flex-auto flex-center">
			...
			<div class="action-buttons">
				...
				<button class="btn btn-floating blue lighten-1 waves-effect waves-light" data-tooltip="<?php echo $__env->yieldContent('btn-add-title'); ?>" data-href="<?php echo $__env->yieldContent('btn-add-route'); ?>">
...
<div class="container pt-1 scroller" style="height: calc(100vh - 145px); width: 100%;">
	<div class="progress" style="position: absolute; top: -10px; left: 0; right: 0; display: none;">
